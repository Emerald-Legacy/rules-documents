...
image::rrg/character_card_explanations.png[]
image::rrg/holding_card_explanations.png[]

<<<

image::rrg/attachment_card_explanations.png[]
image::rrg/event_card_explanations.png[width=95%]
image::rrg/province_card_explanations.png[width=90%]

image::rrg/stronghold_card_explanations.png[90%]
image::rrg/role_card_explanations.png[90%]
