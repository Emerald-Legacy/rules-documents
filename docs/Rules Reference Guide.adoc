...
See [.font-color: blue.underline]#"Personal Honor, Personal Dishonor"#.
...
*Related*: [.font-color: blue.underline]#Running Out of Cards#

=== Duel
Some card abilities initiate a duel between two (or more) characters. For the rules on how to initiate and resolve a duel, see [.font-color: blue.underline]#"D. Duel Timing"#.
...
For event card anatomy, see [.font-color: blue.underline]#"Appendix II: Card Anatomy"#.
...
For holding card anatomy, see [.font-color: blue.underline]#"Appendix II: Card Anatomy"#.
...
[.font-color: blue.underline]#framework step "2.2. Honor bid"#) and during duels. Honor also serves as a victory track to measure an honor win or an honor loss. The
...
=== Own, Ownership
See [.font-color: blue.underline]#"Control and Ownership"#.
...
=== Set
See [.font-color: blue.underline]#"Modifiers"#.
...
rules. See [.font-color: blue.underline]#"Deckbuilding"#.
...
character whose personal honor is changed (see [.font-color: blue.underline]#Personal
...
See [.font-color: blue.underline]#Personal Honor#.
...
- Most card abilities that initiate a duel (see [.font-color: blue.underline]#Duel Timing#) use the
...
- Play one [.font-color: green]#card# from their provinces [.font-color: green]#or hand#.
...
=== [.font-color: green]#Resolve the duel#
...
==== [.font-color: green]#D.2. Establish the challenge#
...
==== [.font-color: green]#D.3. Duel honor bid#
Each player secretly selects a number from 1 to 5 on his or her
...
==== [.font-color: green]#D.4. Reveal honor dials#
The players simultaneously reveal their bids.
...
==== [.font-color: green]#D.5. Transfer honor#
The player with the higher honor bid must give an amount of honor
to the player with the lower honor bid that is equal to the
difference between the two bids. If the bids are equal, no honor is
transferred during this step.

==== [.font-color: green]#D.6. Calculate dueling statistic#
...
===== [.font-color: green]#D.7. Add honor bid, compare values, and determine result#
...
==== [.font-color: green]#D.8. Apply duel results#
...
==== [.font-color: green]#D.9. Duel ends#
...
//todo: Add images with reference to card anatomy

>>>

== [.font-color: green]#Appendix III: Card Clarifications#
...
=== [.font-color: green]#Core Set#
==== [.font-color: blue.underline]#Shameful Display# [.font-color: green]#(24)#
...
more information, see [.font-color: blue.underline]#‘In Play and Out of Play'# on page 10.
