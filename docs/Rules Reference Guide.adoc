...
//todo: This area needs work/images
IN TEXT ON CARD
...
*Related:* <<Tainted&comma; Tainted Status Token>>, <<Status Token>>
...
See <<Personal Honor&comma; Personal Dishonor>>.
...
*Related*: <<Personal Honor&comma; Personal Dishonor>>, <<Glory Count>>
...
=== Personal Honor&comma; Personal Dishonor
...
Honor&comma; Personal Dishonor>> on page 15) or a card effect
...
=== Tainted&comma; Tainted Status Token
...
*Related:* <<Ability>>, <<Action>>, <<Cost>>, <<Effects>>, <<Interrupts>>, <<Limits of Triggered Abilities>>, <<Reactions>>, <<Target>>
